...
```
### Import Data
We imported the following data from the [TidyTuesday community repository](https://github.com/rfordatascience/tidytuesday/tree/main/data/2020/2020-03-03) "Hockey Goals, March 3, 2020". Specifically, the data comes from [HockeyReference.com](https://www.hockey-reference.com/).
```{r}
...
```
### Data Manipulaton
Here we changed the unit of observation in the `game_goals` from player per game in the NHL to statistics per game for the Pittsburgh Penguins. This will be the data we will be focusing on in this analysis. 
```{r}
pit <- game_goals |> 
